<template>
  ...
  <div class="hotel-container hotel-data">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <div class="intro-img photos">
            <img id="coverImg" :src="url+'uploadFile/'+roomInfo.coverImg"  alt="roomInfo.roomName" >
          </div>
        </el-col>
        ...
        <el-col :span="12">
          <div class="intro-txt">
            ...
            <div class="store-attrs">
              <div class="summary">
                <p class="reference"><span>房间号</span> <span id="roomNumber">{{roomInfo.roomNumber}}</span></p>
                <p class="reference"><span>床　型</span> <span id="bedType">{{roomInfo.bedType}}</span></p>
                <p class="reference"><span>宽　带</span> <span id="broadband">{{roomInfo.broadband}}</span></p>
                <p class="reference"><span>标准价</span> ￥<span id="standardPrice">{{roomInfo.standardPrice}}</span></p>
                <p class="activity"><span>会员价</span>
                  <strong class="price">
                  <i>￥</i><span id="memberPrice">{{roomInfo.memberPrice}}</span>
                  </strong>
                </p>
              </div>
            </div>
            ...
            <p class="store-detail-active" id="shopEvent">
              <el-button @click="reserveRoom(roomInfo.id,roomInfo.roomNumber)" color="#FF9434" style="width: 200px;line-height: 52px;font-size: 18px;height: 52px;color: white">
    ...
    <el-card>
      <div class="detail-body">
        <div class="hotel-elem-quote"> 每天14：00后入住，12：00之前退房。</div>
        <div id="roomContent" v-html="roomInfo.remarks">
        </div>
      </div>
  ...
  <!--预定房间信息弹出框 start-->
  <el-dialog align-center v-model="reserveRoomDialogFormVisible" width="42%" destroy-on-close>
